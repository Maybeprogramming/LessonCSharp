namespace Lesson_56
{
    ...
    class Report
    {
        ...
        public Report()
        {
            ...
            {
                "Рядовой","Сержант","Лейтенант","Генерал"
            };
        ...
        private List<Soldier> FillSoldiers()
        {
            ...
            {
                "Иванов","Соколов","Петров","Сидоров","Шевчук","Шапенков","Простаков","Монахов","Михайлин","Ротнов",
                "Бирюков","Мищеряков","Коваленко","Курников","Ковалеров","Иванчкнко","Прокаев","Обувалов","Федотов","Николаев"
            };

            List<string> weapons = new List<string>()
            {
                "Пистолет","Автомат","Пулемет","Винтовка","Кинжал"
            };
